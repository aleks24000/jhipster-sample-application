package fr.fullworkplace.config.timezone;

import fr.fullworkplace.JhipsterSampleApplicationApp;
import fr.fullworkplace.repository.timezone.DateTimeWrapper;
import fr.fullworkplace.repository.timezone.DateTimeWrapperRepository;
